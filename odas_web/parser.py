def helper(left, right, leftdiff, rightdiff):
    ...
    #print("leftacc is" + str(leftacc))
    #print("rightacc  is" + str(rightacc))
    if(rightavg >= 0.5 or leftavg >= 0.5):
        if rightavg >= 0.5 :
            if rightaccavg > 0.00005 or -1.0 * rightaccavg < -0.00005:
                print("danger")
                return
        
        if leftavg >= 0.5 :
            if leftaccavg > 0.00005 or -1.0 * leftaccavg < -0.00005:
                print("danger")
                return
    print("safe to cross")
